					...
					<div class="row">
						...
						<div class="col-4 text-center">
							...
							<form action="../../event/update" method="post">
								...
								<input type="text" class="form-control" style="background-color:white;" value="<?php echo $evento->get_name(); ?>" name="nombre">
								<br><textarea class="form-control" style="background-color:white;" name="desc"><?php echo $evento->get_desc(); ?></textarea>
								<h5 class="title">Imagen (link) </h5>
								<br><input type="text" class="form-control" value="<?php echo $evento->get_image_link(); ?>" name="img">
								...
								<select class="form-control" style="background-color:white;" name="cat" id="categories-select">
