					...
					<div class="row">
						...
						<div class="col-4 text-center">
							...
							<form action="event/add" method="post" enctype="multipart/form-data">
								<input type="text" class="form-control" style="background-color:white;" placeholder="Nombre de Evento..." name="nombre">
								<br><textarea class="form-control" style="background-color:white;" placeholder="Descripcion..." name="desc"></textarea>
