					...
					<div class="row">
						...
						<div class="col-4 text-center">
							...
							<form action="../../event/add_calendar" method="post" onsubmit="return validateCalendarForm(<?php echo count($plazasDB); ?>);" >
                                <input type="hidden" name="id_evt" value="<?php echo $id_evento; ?>">

                                <br><h5 class="title">Fecha y Hora</h5>
								<input type="text" class="form-control date-picker" style="background-color:white;" value="27/09/2018" data-datepicker-color="primary" name="fecha">
								<br><input type="text" class="form-control" style="background-color:white;" placeholder="LA HORA PONELA A LO MACHO DESPUES LO ARREGLAMOS" name="hora">
								<br><textarea class="form-control" style="background-color:white;" placeholder="Descripcion..." name="desc_cal"></textarea>
								...
								<select class="form-control" style="background-color:white;" name="lugar" id="site-select">
								...
								<?php for($i = 0; $i < count($plazasDB); $i++) { ?>
									<div class="row">
										...
										<div class="col-3">
											<input type="hidden" value="<?php echo $plazasDB[$i]->getID(); ?>" name="plazas_id[]">
											<input type="number" value="0" id="plaza<?php echo $i; ?>" name="plazas[]" class="form-control number-input">
										</div>
										<div class="col-3">
											<input type="number" value="0" id="plaza<?php echo $i; ?>" name="plazas_precio[]" class="form-control number-input">
										</div>
									</div>
								<?php } ?>
								...
								<select class="form-control" multiple="multiple" style="background-color:white;" name="artistas[]" id="artists-select">
